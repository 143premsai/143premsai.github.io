...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Prem Sai Krishna kandagattla">
		...
		<div class="container">
			<div class="row centered">
				<div class="col-lg-12">
					...
					<h1>Prem Sai Krishna<br> Kandagattla</h1>
					<h3>Web Designer | B.Tech <sub>CSE</sub> </h3>
				</div><!--/.col-lg-12 -->
			</div><!--/.row -->
		</div><!--/.container -->
	</div><!--/.#headerwrap -->
	...
	<div id="footwrap">
		...
		<div class="row">
				...
				<div class="col-lg-6">
					...
					<p><t>Address</t><br/>
						Flat number: 301,&nbsp; Bommarillu apartments, <br/>
						Vasavi nagar,&nbsp;
				...
				<div class="col-lg-3">
					...
					<p>
						...
						<a href="https://www.facebook.com/143premsai"><i class="icon-facebook"></i></a>
